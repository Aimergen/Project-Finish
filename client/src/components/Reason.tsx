...
//         </div>
//         <div className="border flex flex-col items-center justify-center h-[200px] rounded-2xl shadow-xl bg-[#F3CCFF] bg-[#f5d0a9]">
//           <TbTruckDelivery size={50} className="text-[#ed9539]"/>
//           <div className="px-3 text-center">хурдан шуурхай, найдвартай үйлчилгээ </div>
//         </div>
//         <div className="border flex flex-col items-center justify-center h-[200px] rounded-2xl shadow-xl bg-[#F3CCFF] bg-[#a1e69e]">
//           <TbPigMoney size={50} className="text-[#289e23]"/>
//           <div className="px-3 text-center">гэр бүлийн санхүүгээ бодитоор хэмнэх</div>
//         </div>
//         <div className="border flex flex-col items-center justify-center h-[200px] rounded-2xl shadow-xl bg-[#F3CCFF] bg-[#eb88d7]">
...
export default function App() {
  return (
    <>
      <div className="">
        <h2 className="text-2xl w-full flex justify-center font-semibold my-5">
        ...
        >
          <SwiperSlide>
            {" "}
            <div className="border flex flex-col items-center justify-center h-[200px] rounded-2xl shadow-xl bg-[#F3CCFF]">
