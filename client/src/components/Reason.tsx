...
//         <div className="border  flex flex-col items-center justify-center h-[200px] rounded-2xl bg-[#b88bfc]">
//           <AiFillShopping size={50} className="text-[#7122e6]"/>
//           <div className="px-3 text-center">цэвэрхэн хэрэглэсэн зүйлсээ зарах боломж</div>
//         </div>
//         <div className="border border-black flex flex-col items-center justify-center h-[200px] rounded-2xl bg-[#f5d0a9]">
//           <TbTruckDelivery size={50} className="text-[#ed9539]"/>
//           <div className="px-3 text-center">хурдан шуурхай, найдвартай үйлчилгээ </div>
//         </div>
//         <div className="border border-black flex flex-col items-center justify-center h-[200px] rounded-2xl bg-[#a1e69e]">
//           <TbPigMoney size={50} className="text-[#289e23]"/>
//           <div className="px-3 text-center">гэр бүлийн санхүүгээ бодитоор хэмнэх</div>
//         </div>
//         <div className="border border-black flex flex-col items-center justify-center h-[200px] rounded-2xl bg-[#eb88d7]">
